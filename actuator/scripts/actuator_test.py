    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            # 送药相关
                ...
                if not self.first_arrived_flag:
                    rospy.logwarn("Master已到达,Watcher可出发")
                    self.watcher_go_pub.publish(True)  #watcher可以出发
                    self.first_arrived_flag=True
