...
def client():
    ...
    goal.target_pose.pose.position.x = -2.04284858704
    goal.target_pose.pose.position.y = 2.20917868614
    goal.target_pose.pose.orientation.z = 0.573673982816
    goal.target_pose.pose.orientation.w = 0.819083732863
